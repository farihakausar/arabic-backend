...
const workshopSchema = new mongoose.Schema({
    ...
    artistProfileId: { type: mongoose.Schema.Types.ObjectId, ref: 'ArtistProfile', required: true }, // Reference to the artist profile
    ...
    type: {
        type: String,
        enum: ['Top Rated', 'High Rated', 'Most Attended'], // Type of workshop
        required: true
    },
